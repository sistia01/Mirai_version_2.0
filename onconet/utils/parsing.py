...
def parse_args():
    ...
    parser.add_argument('--hidden_dim', type=int, default=512, help='start hidden dim for discriminator') #added
    parser.add_argument('--num_classes', type=int, default=2, help='start classes  for discriminator') #added

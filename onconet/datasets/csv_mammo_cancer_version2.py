...
@RegisterDataset("sinai_abstract_mammo")
class Sinai_Mammo_Abstract(Abstract_Sinai_Dataset):
    ...
    def create_dataset(self, split_group, img_dir):
        ...
        for _row in self.metadata_json:
            ...
            #... 
            if 'device_name' not in dict_dataset[patient_id]:
                dict_dataset[patient_id]['device_name'] = dict_dataset[dict_dataset['patient_id'] == patient_id]['device_name'].values[0]
            #... 
